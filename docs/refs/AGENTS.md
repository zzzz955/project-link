...
- Link platform source-of-truth files instead of copying platform implementation details.
- Use `project-link:path`, `platform:path`, and `platform-auth:METHOD /route` notation.
